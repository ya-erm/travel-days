...
export const enDict: Dictionary = {
  ...
  'trips.add.car': 'Car',
  'trips.add.ship': 'Ship',
  'trips.add.flight_number': 'Flight number',
  'trips.add.flight_number.search': 'Quick search',
  'trips.add.flight_date': 'Flight date',
  'trips.add.search_by_flight_number': 'Search by flight number',
  'trips.app.failed_to_find_flight': 'Failed to find flight',
  'trips.add.from': 'From',
